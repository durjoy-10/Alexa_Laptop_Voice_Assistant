    ...
    while cap.isOpened():
        ...
        for x, y, w, h in faces:
            ...
            if confidence > UNKNOWN_THRESHOLD:
                ...
                #  Stop immediately if final_name is durjoy or hadi
                if final_name.lower() in ["durjoy", "hadi"]:
                    time.sleep(2)
                ...
                if current_time - last_detection_time < detection_duration:
                    ...
                    cv.putText(frame, processing_name, (50, 50),
                               cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3, cv.LINE_AA)
                ...
                cv.rectangle(frame, (x, y), (x+w, y+h), (255, 0, 255), 2)
                cv.putText(frame, "Unknown Person", (x, y-10),
                           cv.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3, cv.LINE_AA)
    ...
    if pas == "774789":
        ...
        while True:
            ...
            try:
                ...
                print(f"Error in 'alexa' command: {e}")
            ...
            try:
                if "audio call" in query:
                    ...
                    if qry in ["abir", "soumi", "oni", "didi", "tubelight", "tushar", "shilpy"]:
                        pi.press('win')
                        time.sleep(2)
            ...
            try:
                if 'open facebook' in query:
                    ...
                    if facebookImage:
                        ...
                        speak("Could not locate Facebook icon.")
            except pyautogui.ImageNotFoundException:
